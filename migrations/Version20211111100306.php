 ...
 */
final class Version20211111100306 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE operation (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', monthly_account_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', slug VARCHAR(255) NOT NULL, date_op DATE NOT NULL, category VARCHAR(255) NOT NULL, label VARCHAR(255) NOT NULL, credit DOUBLE PRECISION DEFAULT NULL, debit DOUBLE PRECISION DEFAULT NULL, checked TINYINT(1) NOT NULL, INDEX IDX_1981A66D52763F3F (monthly_account_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
